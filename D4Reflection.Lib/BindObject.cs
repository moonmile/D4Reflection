...
namespace D4Reflection.Lib
{
    ...
    public class BindObject<T> where T : class
    {
        /// <summary>
        /// バインド先のオブジェクト
        /// </summary>
        ...
        public TP FindName<TP>(string name)
        {
            return TypeExtentions.FindTarget<TP>(this.Target, name, true);
        }
